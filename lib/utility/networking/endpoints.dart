class EndPoints {
  ...
  static String checkOutFile(int folderId, int fileId) =>
      "/folders/$folderId/files/$fileId/checkout";
  static String deleteFile(int folderId, int fileId) =>
      "/folders/$folderId/files/$fileId";
  ...
  static String addNewFolder = "/folders";
  static String deleteFolder(int folderId) => "/folders/$folderId";
  static String removeUserFromFolder(int folderId, int userId) =>
      "/folders/$folderId/remove-user/$userId";
  static String addUserFromFolder(int folderId, String email) =>
      "/folders/$folderId/add-user/$email";
}

...
import 'package:file_manager/features/folder/domain/use_cases/get_myfolders_usecase.dart';
...
class FolderBloc extends Bloc<FolderEvent, FolderState> {
  FolderBloc() : super(FolderInitial()) {
    ...
    on<GetMyFolderEvent>((event, emit) async {
      emit(FolderInitial());

      GetMyFolderUsecase usecase = GetMyFolderUsecase(folderRepoImpl);
      final response = await usecase.call(event);
